...
describe('scheduler recurring', () => {
  ...
  test.each([
    [1, new Date(2020, 4, 4), new Date(0, 0, 0, 12, 23, 56), new Date(2020, 4, 4, 12, 23, 56)],
    [2, new Date(2020, 4, 4), new Date(0, 0, 0, 23, 23, 56), new Date(2020, 4, 4, 23, 23, 56)],
    [10, new Date(2020, 4, 4), new Date(0, 0, 0, 12, 54, 56), new Date(2020, 4, 4, 12, 54, 56)],
    [10, new Date(2020, 4, 4, 13), new Date(0, 0, 0, 12, 54, 56), new Date(2020, 4, 14, 12, 54, 56)]
    ...
    (frecuency: number, inputDate: Date, occurOnceTime: Date, expectedDate: Date) => {
      ...
      const nextDate: Date | undefined = scheduler.getNextDateTime(inputDate)?.nextDate;
  ...
  test.each([
    ...
    (inputNumberWeeks: number, inputDate: Date, expectedDate: Date) => {
      const startDate: Date = new Date(2020, 0, 1);
      const occurOnceTime: Date = new Date(0, 0, 0, 18, 23, 45);
      const limits: Limits = new Limits(startDate, null);
      const week: Week = new Week();
      week.monday = true;
      week.tuesday = true;
