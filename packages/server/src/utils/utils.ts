import { Culture } from "../localization/enums";

export default class Utils {
    public static formatDate(date: Date, culture: Culture): string {
        return date.toLocaleDateString(culture, { day: '2-digit', month: '2-digit', year: 'numeric' });
    }

    public static formatTime(time: Date, culture: Culture): string {
        return time.toLocaleTimeString(culture, { hour: '2-digit', minute: '2-digit', second: '2-digit' });
    }
